...
export const mutations = {
  sentChat(state, payload) {
    ...
    // console.log(state.friends.find((c) => c.id === payload.id));
    // console.log(state.friends.find((c) => (c.id = id)));
    // console.log("before");
    // console.log(state.friends.find((c) => (c.id = payload.id)).chatlog);

    // state.friends.find((c) => (c.id = payload.id)).chatlog.push(message);
    // console.log("pushed");
    // console.log(state.friends.find((c) => (c.id = payload.id)).chatlog);
  },
};
